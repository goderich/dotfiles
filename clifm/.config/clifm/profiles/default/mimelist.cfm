...
X:N:.*\.djvu$=zathura;djview;evince;atril
X:N:.*\.epub$=zathura;mupdf;ebook-viewer
...
X:^image/.*=sxiv;fim;display;nsxiv;pqiv;gpicview;qview;qimgv;inkscape;mirage;ristretto;eog;eom;xviewer;viewnior;nomacs;geeqie;gwenview;gthumb;gimp
