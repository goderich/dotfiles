...
#+BEGIN_SRC emacs-lisp
  (use-package evil
    ...
    (define-key evil-normal-state-map (kbd "SPC w w") #'evil-window-next)
    (define-key evil-normal-state-map (kbd "SPC w q") #'evil-window-delete)
...
#+BEGIN_SRC emacs-lisp
  (use-package org
    ...
    :config
    (evil-define-key 'normal org-mode-map (kbd ", s") #'org-edit-src-code)
    (evil-define-key 'normal org-src-mode-map (kbd "Z Z") #'org-edit-src-exit)
    (evil-define-key 'normal org-src-mode-map (kbd "Z Q") #'org-edit-src-abort))
