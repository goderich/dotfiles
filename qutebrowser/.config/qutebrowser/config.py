...
## Type: String
c.content.headers.accept_language = 'en-US,en,zh-TW'
...
config.bind('n', 'hint')
config.bind('v', 'enter-mode insert')
...
config.bind('<Shift-Down>', 'command-history-next', mode='command')
...
config.bind('<Shift-Up>', 'command-history-prev', mode='command')
